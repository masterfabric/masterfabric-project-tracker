...
type Resolver struct {
	...
	ListOrganizationProjectOrgParticipationsUC *organizationUC.ListOrganizationProjectOrgParticipationsUseCase
	UpdateOrganizationProjectOrgParticipationCapabilitiesUC *organizationUC.UpdateOrganizationProjectOrgParticipationCapabilitiesUseCase
	TransferOrganizationProjectOwnershipUC *organizationUC.TransferOrganizationProjectOwnershipUseCase
	// GFG-174
