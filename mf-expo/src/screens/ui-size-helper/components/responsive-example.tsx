...
import { Sizing, useResponsive , getThemeColors, useTheme } from 'masterfabric-expo-core';
  ...
  return (
    ...
    >
      ...
      <View>
        ...
        >
          This text size adapts based on screen width. On phones it is {Sizing.typography.fontSize.m}px, on
          tablets {Sizing.typography.fontSize.l}px, and on desktop {Sizing.typography.fontSize.xl}px.
        </ThemedText>
      </View>
